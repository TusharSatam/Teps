        ...
        .then(res => {
          if (res) {
            if (res?.data?.varified) {
              ...
              //   "verify_link": `https://teps.school.app/verify?sdfbkjfewihuf=${res?.data?._id}&pfgvsckvnlksfwe=${res?.jwt}`,
              //   "from": "things@ecu.org"
              // }, '8zEAglGBvaOwqdqTd')
              //   .then((result) => {
              //     setIsLoading(false);
              ...
              const data = {
                ...
                "html": `
                  ...
                  <p>https://teps.school.app/verify?sdfbkjfewihuf=${res?.data?._id}&pfgvsckvnlksfwe=${res?.jwt}</p><br/>
                  <p>Regards,</p>

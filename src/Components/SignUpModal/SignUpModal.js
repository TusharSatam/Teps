              ...
              userRegister(formData)
                .then(res => {
                  ...
                  const data = {
                    ...
                    <p>https://teps.school.app/verify?sdfbkjfewihuf=${res?.data?.data?._id}&pfgvsckvnlksfwe=${res.data.jwt}</p><br/>
                    <p>Regards,</p>
                  ...
                  //   "verify_link": `https://teps.school.app/verify?sdfbkjfewihuf=${res?.data?.data?._id}&pfgvsckvnlksfwe=${res.data.jwt}`,
                  //   "from": "things@ecu.org"
                  // }, '8zEAglGBvaOwqdqTd')
                  //   .then((result) => {
                  //     setVerifyModal(true)

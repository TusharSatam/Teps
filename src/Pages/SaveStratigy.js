...
const SaveStratigy = () => {
  ...
  return (
    <div className='container'>
      <div style={{ background: "#FFFFFF" }} className='border-bottom card_pad'>
        <div className='my-4'>
          <div className='d-flex justify-content-between my-4 '>
            ...
            <div className='col-9 ms-4 col-md-8 Strategy_count_article'>
              <p style={{ fontSize: "20px", fontWeight: "500" }}>Learning Outcome: Makes text-to-self connections with the character</p>
              <p>
              ...
              <div className='d-flex align-items-center my-3'>
                <img style={{ cursor: "pointer" }} className="save_likes" src={LikedIcon} alt="" />
              </div>
            </div>

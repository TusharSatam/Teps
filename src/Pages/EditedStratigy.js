...
import { getHindiStratigysEditedbyUser, getMultitHiStr } from '../services/hindiStratigys';
      ...
      .then(res => {
        ...
        if (languageSelect === "en") {
         ...
         getEdits(user._id)
          ...
          console.log("6521953d46e580f49478ad11");
          getHindiStratigysEditedbyUser("6521953d46e580f49478ad11")
            .then(res => {
              console.log(res);
              ...
              {stratigyFilData?.map((res, index) => (
                <div key={index} className="container">
                  <div className="card_pad">
                   ...
                   {location.pathname!="/profile" &&    <Link to={`/singleUserStratigy/${res._id}`} className="linkStyle">
                          <div className="me-1">
                            <div>
                        ...
                        <div>
                          <Link to={`/singleUserStratigy/${res._id}`} className="linkStyle">
                            ...
                            <div className="strategyReadmore">
                              <Link to={`/singleUserStratigy/${res._id}`}>
                                Read more...
                              </Link>
                            </div>
                          </Link>

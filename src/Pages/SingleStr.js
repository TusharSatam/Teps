  ...
  return (
    <div>
      <div className='saveStrParent' >
        <div className='text-white text-center headText mt-2 mt-md-0'>Strategy screen</div>
      </div>
          ...
          <div className='my-4'>
            <div className='d-flex justify-content-between my-4 '>
              ...
              <div className='col-9 ms-4 col-md-7 '>
                <p className='savestr_head'>Learning Outcome: {str["Learning Outcome"]}</p>
              ...
              <div className='col-md-3 d-none d-md-block dev_dom_bg'>
                <div className='d-flex flex-column align-items-center justify-content-center'>
                  <div className='mt-3'>
                    <span className='Dev_dom'>Developmental Domains</span>
                  </div>
